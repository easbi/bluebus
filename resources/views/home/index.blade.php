      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="{{asset('public/QuickStart/assets/img/clients/client-1.png')}}" class="img-fluid" alt="">
          </div>

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="{{asset('public/QuickStart/assets/img/clients/client-2.png')}}" class="img-fluid" alt="">
          </div>

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="{{asset('public/QuickStart/assets/img/clients/client-3.png')}}" class="img-fluid" alt="">
          </div>

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="{{asset('public/QuickStart/assets/img/clients/client-4.png')}}" class="img-fluid" alt="">
          </div>

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="{{asset('public/QuickStart/assets/img/clients/client-5.png')}}" class="img-fluid" alt="">
          </div>

          <div class="col-xl-2 col-md-3 col-6 client-logo">
            <img src="{{asset('public/QuickStart/assets/img/clients/client-6.png')}}" class="img-fluid" alt="">
          </div>
